...
export function WishlistIcon() {
  ...
  return (
    <Link href="/wishlist" style={{ width: '40px', height: '40px', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#1A1A18', borderRadius: '50%', textDecoration: 'none', position: 'relative' }}>
