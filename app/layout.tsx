        ...
        <header style={{ position: 'sticky', top: 0, zIndex: 100, background: 'rgba(248,245,240,0.96)', backdropFilter: 'blur(10px)', borderBottom: '1px solid #EAE3D9', height: '72px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '0 56px' }}>
          ...
          <div style={{ display: 'flex', gap: '4px', alignItems: 'center' }}>
            ...
            <Link href="/cart" style={{ width: '40px', height: '40px', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#1A1A18', borderRadius: '50%', position: 'relative', textDecoration: 'none' }}>
              ...
              <span style={{ position: 'absolute', top: '6px', right: '6px', width: '15px', height: '15px', background: '#1A1A18', color: '#F8F5F0', borderRadius: '50%', fontSize: '8px', fontWeight: 500, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>0</span>
            </Link>
          </div>
        </header>
