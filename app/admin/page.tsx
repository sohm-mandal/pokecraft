  ...
  return (
    <>
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '40px 20px' }}>
        ...
        {/* Stats */}
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(175px, 1fr))', gap: '14px', marginBottom: '40px' }}>
          {([
            ...
            {recentOrders.length === 0 ? (
              ...
              recentOrders.map((order, i) => (
                <div key={order.id} style={{
                  ...
                  borderBottom: i < recentOrders.length - 1 ? '1px solid #F5F0EB' : 'none',
                }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
                    ...
                    <div>
                      ...
                      <p style={{ margin: 0, fontSize: '11px', color: '#9A918A' }}>
