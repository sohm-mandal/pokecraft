...
const inputStyle: React.CSSProperties = {
  ...
  fontSize: '14px', fontFamily: 'inherit', background: 'white', outline: 'none',
    ...
    <div style={{ minHeight: '80vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '40px 20px' }}>
      <div style={{ width: '100%', maxWidth: '400px' }}>
        <div style={{ textAlign: 'center', marginBottom: '40px' }}>
          ...
          <h1 style={{ fontFamily: 'var(--font-playfair, Georgia, serif)', fontSize: '2.2rem', color: '#1A1A18', margin: 0 }}>Sign in to PokéCraft</h1>
        </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '4px 0' }}>
            ...
            <span style={{ fontSize: '11px', color: '#9A918A' }}>or sign in with username</span>
            <div style={{ flex: 1, height: '1px', background: '#E4DBD0' }} />
          </div>
          ...
          <form onSubmit={handleLogin} style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginTop: '2px' }}>
              <Link
                href={`/forgot-password?callbackUrl=${encodeURIComponent(dest)}`}
                style={{ fontSize: '12px', color: '#C9906A', textDecoration: 'none' }}
              >
                Forgot password?
              </Link>
              <Link
                href={`/signup?callbackUrl=${encodeURIComponent(dest)}&mode=signup`}
                style={{ fontSize: '12px', color: '#9A918A', textDecoration: 'none' }}
              >
